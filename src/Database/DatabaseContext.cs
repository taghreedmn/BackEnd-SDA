    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
          ...
          var Studio3 = new GameStudio { GameStudioId = Guid.NewGuid(), StudioName = "Valve", StudioPicturePath = "pic3/png" };
            ...
            var VideoGameInfo1 = new VideoGameInfo {VideoGameInfoId = Guid.NewGuid(), GameName = "Dark souls", Description = "Description for Game 1", YearOfRelease = "2019-09-08", TotalRating = 3,PublisherId = Publisher1.PublisherId, GamePicturePath= ""};
            var VideoGameInfo2 = new VideoGameInfo {VideoGameInfoId = Guid.NewGuid(), GameName = "Fifa", Description = "Description for Game 2", YearOfRelease = "2023-07-04", TotalRating = 5,PublisherId = Publisher2.PublisherId, GamePicturePath= ""};

            var VideoGameVersion1 = new VideoGameVersion {VideoGameVersionId = Guid.NewGuid(), Price = 80, VideoGameInfoId = VideoGameInfo1.VideoGameInfoId, GameConsoleId = Console1.GameConsoleId};
            var VideoGameVersion2 = new VideoGameVersion {VideoGameVersionId = Guid.NewGuid(), Price = 85, VideoGameInfoId = VideoGameInfo2.VideoGameInfoId, GameConsoleId = Console2.GameConsoleId};

            var Store1 = new Store{StoreId = Guid.NewGuid(), WorkHours = 35, Location = "Riyadh"};
            var Store2 = new Store{StoreId = Guid.NewGuid(), WorkHours = 40, Location = "Jeddah"};

            var Inventory1 = new Inventory { InventoryId = Guid.NewGuid(),VideoGameVersionId = VideoGameVersion1.VideoGameVersionId, StoreId = Store1.StoreId, GameQuantity = 250 };
            var Inventory2 = new Inventory { InventoryId = Guid.NewGuid(),VideoGameVersionId = VideoGameVersion2.VideoGameVersionId, StoreId = Store2.StoreId, GameQuantity = 400 };
            ...
            var Supply1 = new Supply { SupplyId = Guid.NewGuid(), SupplierId = Supplier1.SupplierId, VideoGameVersionId = VideoGameVersion1.VideoGameVersionId, SupplyQuantity = 100, SupplierDate = DateTime.UtcNow, InventoryId = Inventory1.InventoryId };
            var Supply2 = new Supply { SupplyId = Guid.NewGuid(), SupplierId = Supplier2.SupplierId, VideoGameVersionId = VideoGameVersion2.VideoGameVersionId, SupplyQuantity = 50, SupplierDate = DateTime.UtcNow.AddDays(-1), InventoryId = Inventory2.InventoryId };
